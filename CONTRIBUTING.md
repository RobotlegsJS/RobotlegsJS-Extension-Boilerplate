# Contributing to RobotlegsJS-Extension-Boilerplate

## Setup

1 - Clone your fork of the repository:
```
$ git clone https://github.com/YOUR_USERNAME/RobotlegsJS-Extension-Boilerplate.git
```
...
[github issues](https://github.com/RobotlegsJS/RobotlegsJS-Extension-Boilerplate/issues).